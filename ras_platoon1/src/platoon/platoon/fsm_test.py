...
DUTY_MIN = 30
DUTY_MAX = 90
DUTY_LEVEL_STEP = 10     # 곡선 등 초음파 유실 시 앞차 speed_level 변화 방향으로 보정
...
class DrivingCommand:
    ...
    cruise_duty: Optional[int] = None   # ← 추가
    emergency: bool = False
...
class PlatoonFSM:
    def __init__(self, vehicle_id: int, is_designated_leader: bool,
        ...
        self._last_partner_level: Optional[int] = None
