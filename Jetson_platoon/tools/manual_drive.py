...
from platoon_control.manual_control import ManualController
from platoon_control.stm32_interface import STM32Interface
from platoon_control.platoon_fsm import V_MAX
from platoon_control.driving_control import MAX_STEERING_RAD

LOOP_DT = 0.02  # 50Hz — platoon_control_node와 동일한 주기
